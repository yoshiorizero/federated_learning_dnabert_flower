...
from modeling_bert import BertForLongSequenceClassification
from modeling_bert import BertForLongSequenceClassificationCat
from glue import glue_compute_metrics as compute_metrics
from glue import glue_convert_examples_to_features as convert_examples_to_features
from glue import glue_output_modes as output_modes
from glue import glue_processors as processors
...
def main():
    ...
    parser.add_argument(
        # 8
        "--per_gpu_pred_batch_size", default=128, type=int, help="Batch size per GPU/CPU for prediction.",
    )
    parser.add_argument(
